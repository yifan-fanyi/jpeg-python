...
class JPEG_Huffman_utli():
    def __init__(self):
        pass

    def int2bit(self, X, len_bits):
        if X < 0:
            X += pow(2, len_bits)-1
        bits = "{0:b}".format(X)
    ...
    def bit2int(self, bits):
        ...
        for i in range(len(bits)):
            val = 2 * val + (int)(bits[i])
        if val < pow(2, len_bits-1):
            val = val - pow(2, len_bits) + 1
        return val
    ...
    def Category(self, val):
        if val == 0:
            ...
            cat = (int)(math.log2(abs(val)))+1 
        return cat

class JPEG_Huffman_Luma(JPEG_Huffman_utli):
    def __init__(self):
        super().__init__()
        self.DC_code_word = { 0: "00", 
                                   1: "010", 
                                   2: "011",
                                   3: "100",
                                   4: "101",
        ...
        self.AC_code_word = { '0/0' : "1010",
                                  ...
                                  '15/0' : "11111111001"}
        self.inv_DC_code_word = {v: k for k, v in self.DC_code_word.items()}
        self.inv_AC_code_word = {v: k for k, v in self.AC_code_word.items()}
        
class JPEG_Huffman_Chroma(JPEG_Huffman_utli):
    def __init__(self):
        super().__init__()
        self.DC_code_word = { 0: "00", 
                                   1: "010", 
